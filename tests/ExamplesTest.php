...
class ExamplesTest extends TestCase
{
    ...
    {
        $key = HmacKey::create('12345678901234567890123456789012');
    ...
    {
        $privateKey = file_get_contents(__DIR__ . '/../assets/keys/ed25519-1.sec');
        $publicKey = file_get_contents(__DIR__ . '/../assets/keys/ed25519-1.pub');
