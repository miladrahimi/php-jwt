...
class Ed448PrivateKeyTest extends TestCase
{
    ...
    public function test_with_valid_key_file_it_should_pass()
    {
        ...
        $key = new Ed448PrivateKey(__DIR__ . '/../../../assets/keys/ed448-private.pem');
    ...
    public function test_with_valid_key_string_it_should_pass()
    {
        ...
        $key = new Ed448PrivateKey(file_get_contents(__DIR__ . '/../../../assets/keys/ed448-private.pem'));
        $this->assertNotNull($key->getResource());
    }
    ...
    public function test_id()
    {
        ...
        $key = new Ed448PrivateKey(__DIR__ . '/../../../assets/keys/ed448-private.pem', '', 'id-1');
    ...
    public function test_with_invalid_key_path_it_should_fail()
    {
        ...
        new Ed448PrivateKey('Invalid Key!');
    }
    ...
    public function test_with_invalid_key_file_it_should_fail()
    {
        ...
        $this->expectException(InvalidKeyException::class);
        new Ed448PrivateKey(__DIR__ . '/../../../assets/file.empty');
    }
    ...
    public function test_without_ed448_support_it_should_fail()
    {
        ...
        new Ed448PrivateKey(__DIR__ . '/../../../assets/keys/ed448-private.pem');
    }
}
