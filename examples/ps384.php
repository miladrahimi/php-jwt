...
/**
 * PS384 — RSA-PSS with SHA-384 (asymmetric: private key signs, public key verifies).
 *
 * Run:  php examples/ps384.php
 */
...
$signer = new PS384Signer($privateKey);
...
$verifier = new PS384Verifier($publicKey);
