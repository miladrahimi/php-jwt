...
/**
 * RS384 — RSA with SHA-384 (asymmetric: private key signs, public key verifies).
 *
 * Run:  php examples/rs384.php
 */
...
$signer = new RS384Signer($privateKey);
...
$verifier = new RS384Verifier($publicKey);
